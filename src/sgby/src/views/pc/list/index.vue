...
import TopNavNormal from '../../../components/pc/top-nav-normal/top-nav-normal';
import DownloadSider from '../../../components/pc/download-sider/download-sider';
import NewsPaging from '../../../components/pc/news-paging/news-paging';
...
export default {
    ...
    mounted(){
        ...
        this.page = util.getParams().page ? parseInt(util.getParams().page) : 1;
        switch(this.cate){
            case 'xinwen':
                this.cateId = 1;
                break;
